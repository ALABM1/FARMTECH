 ...
 * @author aladi
 */
public class Agriculteur1Controller implements Initializable {
    ...
    @FXML
    private void gestionparc(ActionEvent event) {
try {
...
try {
    ...
    @FXML
    private void gestiontresorerie(ActionEvent event) {
try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("../gui/tresorerieFXML.fxml"));
            Parent root = loader.load();
            Scene scene = new Scene(root);
